 ...
 * @swagger
 * paths:
 *   /experienceNaturalDisaster:
 *     post:
 *       tags:
 *         - experience_natural_disaster
 *       description: Increases or decrease the sadness, fear and surprise emotion in the emotional entity using Paul Ekman's emotional model individually or in combination with James A. Russell's emotional model (PAD).
 *       requestBody:
 *         required: true
 *         content:
 *           application/json:
 ...
 *
 *   schemas:
 *     experienceNaturalDisasterPADBody:
 *       type: object
 *       properties:
 *         emotional_entity:
 *           type: array
 ...
 *           example: [0, 10, 10, 0, 0, 10, 20, 40, 60]
 *         sadness_amount:
 *           type: integer
 *           description: Amount of sadness mutation
 *           example: 10
 ...
 *           example: 5
 *
 *     experienceNaturalDisasterPADSuccess:
 *       type: object
 *       properties:
 *         statusCode:
 *           type: integer
 ...
 *           items:
 *             type: integer
 *           example: [0, 20, 15, 0, 0, 25, 40, 80, 65]
 */
