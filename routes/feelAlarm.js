 ...
 *       tags:
 *         - feel_alarm
 *       description: Increases or decrease the fear and surprise emotion in the emotional entity using Paul Ekman's emotional model individually or in combination with James A. Russell's emotional model (PAD).
 *       requestBody:
 *         required: true
 *         content:
 *           application/json:
 ...
 *           example: [0, 0, 10, 0, 0, 10, 20, 40, 60]
 *         fear_amount:
 *           type: integer
 *           description: Amount of fear mutation
 *           example: 10
 ...
 *           items:
 *             type: integer
 *           example: [0, 0, 20, 0, 0, 15, 40, 80, 65]
 */
