 ...
 *     post:
 *       tags:
 *         - experience_injustice
 *       description: Increases or decrease the sadness, fear, anger and surprise emotions in the emotional entity using Paul Ekman's emotional model individually or in combination with James A. Russell's emotional model (PAD).
 *       requestBody:
 *         required: true
 *         content:
 *           application/json:
 ...
 *           example: [0, 10, 10, 10, 0, 10, 20, 40, 60]
 *         sadness_amount:
 *          type: integer
 *          description: Amount of sadness mutation
 *          example: 5
 ...
 *           items:
 *             type: integer
 *           example: [0, 15, 20, 25, 0, 30, 40, 80, 65]
 */
