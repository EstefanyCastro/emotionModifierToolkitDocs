 ...
 *       tags:
 *         - feel_indifference
 *       description: Increases or decrease the anger and disgust emotion in the emotional entity using Paul Ekman's emotional model individually or in combination with James A. Russell's emotional model (PAD).
 *       requestBody:
 *         required: true
 *         content:
 *           application/json:
 ...
 *           example: [0, 0, 0, 10, 10, 0, 20, 40, 60]
 *         anger_amount:
 *           type: integer
 *           description: Amount of anger mutation
 *           example: 10
 ...
 *           items:
 *             type: integer
 *           example: [0, 0, 0, 20, 15, 0, 40, 80, 65]
 */
