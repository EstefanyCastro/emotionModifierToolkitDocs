 ...
 *       tags:
 *         - feel_proud
 *       description: Increases or decrease the happiness and anger emotion in the emotional entity using Paul Ekman's emotional model individually or in combination with James A. Russell's emotional model (PAD).
 *       requestBody:
 *         required: true
 *         content:
 *           application/json:
 ...
 *           example: [10, 0, 0, 10, 0, 0, 20, 40, 60]
 *         happiness_amount:
 *           type: integer
 *           description: Amount of happiness mutation
 *           example: 10
 ...
 *           items:
 *             type: integer
 *           example: [20, 0, 0, 15, 0, 0, 40, 80, 65]
 */
